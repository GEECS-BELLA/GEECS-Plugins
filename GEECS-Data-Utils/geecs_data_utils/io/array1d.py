...
class Data1DConfig(BaseModel):
    r"""Configuration for reading 1D array-like data files."""
    ...
    x_trace_index: Optional[int] = Field(
        ...
        ge=0,
        description=(
            "Trace/channel index for x values. If None, x-axis is derived "
            "from waveform properties where available."
        ),
    )
