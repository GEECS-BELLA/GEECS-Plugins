...
the beam measure via its ``compute_slopes`` flag.
Slopes intentionally retain their legacy local pixel-index convention.
"""
...
from geecs_analysis.algorithms.basic_line_stats import (
...
def extract_line_stats(
    ...
    Examples
    --------
    >>> from geecs_analysis.algorithms.basic_line_stats import compute_center_of_mass
