...
from geecs_python_api.controls.interlocks import (InterlockConstructor)
...
builder = InterlockConstructor('BELLA', host=SERVER_IP, port=SERVER_PORT, )
...
try:
    while True:
        ...
        # state = builder.get_monitor_state('Camera Multi Check')
