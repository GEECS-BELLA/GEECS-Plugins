function [wf,timI] = fALSWvFrmV01(fNam,tim)
%% Get waveform and time index for ALS experiments
% [wf,timI] = fALSWvFrmV01(fNam,tim)
% fNam: file name
% tim: time for ROI
% wf: waveform
% timI: Index for time for waveform
%
% ALS Wave Form read ver.1
% Written by Kei Nakamura
% Created on Monday, June 29th 2009.
% Modified on
...
[delete,timI(9)] = min(abs(wf(:,1)-tim(9)));
