function [arry,pulse] = fBllFrgSim4FitV04(cmpLPeak,dsprsnIn,cmpPara,cmrPara,diag,figH,eS,osPrp)
...
diagDsp = fBllDiagDsprsnV01(800,diag,dspOrd);
...
for kk=1:numel(D)
    cmpDsp(kk,:) = fCpaDispersionV02(D(kk),N,800,alpD,-1,dspOrd);
end
