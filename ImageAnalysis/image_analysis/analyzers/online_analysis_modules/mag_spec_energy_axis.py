...
def return_acave3_energy_axis(pixel_axis):
    ...
    mag_field = '200mT'
    if mag_field == '200mT':
        coefs_array = [ 8.47480099e-35, -4.65761172e-31,  1.10678933e-27, -1.48066938e-24,
                      1.21643136e-21, -6.26281472e-19,  1.95560040e-16, -3.18977419e-14,
                      6.22842632e-13,  7.21795620e-10, -7.45492128e-08,  5.89038941e-05,
                      6.44585561e-02,  6.54719816e+01]
    elif mag_field == '251mT':
