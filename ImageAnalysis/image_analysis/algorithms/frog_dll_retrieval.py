...
#: The retrieval parameters — the ``frog_retrieval`` analyzer spec from
#: GEECS-Schemas (``analyzer: {kind: frog_retrieval, ...}`` in a diagnostic).
FrogRetrievalConfig = FrogRetrievalSpec
