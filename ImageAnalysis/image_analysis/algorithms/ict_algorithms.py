...
import numpy as np
from geecs_schemas.analysis import IctAnalyzerSpec
...
#: The ICT parameters — the ``ict`` analyzer spec from GEECS-Schemas
#: (``analyzer: {kind: ict, ...}`` in a diagnostic).
ICTAnalysisConfig = IctAnalyzerSpec
