...
class EBeamProfileAnalyzer(ImageAnalyzer):
    def __init__(self, background: Background = None, camera_name: str = None, preprocessed: bool = False,):
        """
        Initialize EBeamProfileAnalyzer analyzer for a specific camera.
        ...
        background : Optional[Background]
            background object to use with this analyzer. If none is sent, an empty one will be generated by super
        preprocessed : bool
