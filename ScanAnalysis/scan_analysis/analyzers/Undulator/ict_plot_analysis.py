...
class ICTPlotAnalysis(ScatterPlotterAnalysis):
    def __init__(self, scan_tag: ScanTag, skip_plt_show: bool = True, flag_logging: bool = False):
...
if __name__ == "__main__":
    ...
    analyzer = ICTPlotAnalysis(scan_tag=tag, skip_plt_show=False, flag_logging=True)
