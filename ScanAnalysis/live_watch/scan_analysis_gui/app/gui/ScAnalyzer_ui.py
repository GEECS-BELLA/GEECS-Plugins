...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.checkBoxOverwrite.setGeometry(QtCore.QRect(20, 270, 191, 20))
        self.checkBoxOverwrite.setObjectName("checkBoxOverwrite")
        self.lineDocumentID = QtWidgets.QLineEdit(self.centralwidget)
        self.lineDocumentID.setGeometry(QtCore.QRect(100, 330, 160, 30))
        ...
        self.checkBoxScanlog.setGeometry(QtCore.QRect(20, 300, 181, 20))
        self.checkBoxScanlog.setObjectName("checkBoxScanlog")
        self.lineExperimentName = QtWidgets.QLineEdit(self.centralwidget)
        self.lineExperimentName.setGeometry(QtCore.QRect(360, 10, 160, 30))
        ...
        self.labelExperimentName.setGeometry(QtCore.QRect(250, 10, 111, 21))
        self.labelExperimentName.setObjectName("labelExperimentName")
        self.buttonReset = QtWidgets.QPushButton(self.centralwidget)
        self.buttonReset.setGeometry(QtCore.QRect(530, 10, 51, 21))
