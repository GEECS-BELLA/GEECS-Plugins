...
class BaseEvaluator:
    ...
    def __init__(
        ...
        # Deferred import kept from the geecs_scanner era (the old
        # model rebuild created an import cycle through the engine);
        # harmless now, left lazy to keep module import light.
        from geecs_bluesky.optimization.config_models import _split_analyzer_entry
