...
mklink "%ANACONDA_Xopt_GEECS%\Lib\Badger-Plugins\environments\double_camera_exposure_time_test" "%GEECS_Plugins_Directory%\Xopt-GEECS\badger-plugins\environments\double_camera_exposure_time_test"
mklink "%ANACONDA_Xopt_GEECS%\Lib\Badger-Plugins\environments\parent_geecs_env" "%GEECS_Plugins_Directory%\Xopt-GEECS\badger-plugins\environments\parent_geecs_env"
