...
Loops through a scan tdms file and finds the relative correlation between all of the scalars calculated by the MagSpec
analyzer.  Works well for this limited application, need a further version to also include laser and gas parameters.
