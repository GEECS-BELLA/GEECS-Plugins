...
`geecs_core.db.scalar_policy`, numeric and enum types, minus the
timestamp ladder), holding the value pushed with that frame or `NaN`.  The names (`file_plugin.attribute_names`, both parts
