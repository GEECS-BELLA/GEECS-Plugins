...
instead of the catalog carrying coefficients. Step 3 landed the same day
(0.90.0: `GeecsNamespace.add_pseudos`, the startup profile calls it, the
preset expansion stops refusing `kind: pseudo`).
