...
OWN_ENV_PKGS="GeecsBluesky GeecsCAGateway GeecsPvaGateway GEECS-Console GEECS-Core GEECS-LogTriage GEECS-Scan-MCP"
...
run_suite() {
    case "$1" in
        ...
        GeecsCAGateway|GeecsPvaGateway|GEECS-Core|GEECS-LogTriage|GEECS-Scan-MCP)
