...
OWN_ENV_PKGS="GeecsBluesky GeecsCAGateway GeecsPvaGateway GEECS-Console GEECS-Core GEECS-DataPortal GEECS-LogTriage GEECS-MCP GeecsScanLog"
...
run_suite() {
    case "$1" in
        ...
        GeecsCAGateway|GeecsPvaGateway|GEECS-Core|GEECS-DataPortal|GEECS-LogTriage|GEECS-MCP|GeecsScanLog)
